 ...
 */
public class GradientDescentNesterovMomentum implements UpdateFunction {
    INDArray update;
    float mu;
    ...
    public GradientDescentNesterovMomentum() {
        this.mu = mu_values[1];
    }
    
    public GradientDescentNesterovMomentum(int muChoice) {
