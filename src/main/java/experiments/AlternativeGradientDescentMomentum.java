 ...
 */
public class AlternativeGradientDescentMomentum implements UpdateFunction {
    INDArray update;
    float mu;
    ...
    public AlternativeGradientDescentMomentum() {
        this.mu = mu_values[1];
    }
    
    public AlternativeGradientDescentMomentum(int muChoice) {
